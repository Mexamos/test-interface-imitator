;(function(){
    ...
    let initRenderPlugin = function() {
        ...
        plugin_wrapper.id = 'test-interface-imitator-wrapeer'
        ...
        let image_toggle_position_wrapper = document.createElement('div')
        image_toggle_position_wrapper.classList.add('tii-img-toggle-position-wrapper')
        
        image_toggle_position_wrapper.appendChild(img_toggle_position)

        let header_wrapper = document.createElement('div')
        header_wrapper.classList.add('tii-header')
        plugin_wrapper.appendChild(header_wrapper)

        header_wrapper.appendChild(image_toggle_position_wrapper)
        ...
        plugin_wrapper.appendChild(body_wrapper)
        ...
        body_wrapper.appendChild(button_wrapper)
